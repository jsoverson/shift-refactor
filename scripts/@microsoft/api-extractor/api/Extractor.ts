...
import ts, { Program } from '@microsoft/api-extractor/node_modules/typescript/lib/typescript';
...
import { Collector } from '@microsoft/api-extractor/lib/api/../collector/Collector';
import { DtsRollupGenerator, DtsRollupKind } from '@microsoft/api-extractor/lib/api/../generators/DtsRollupGenerator';
import { ApiModelGenerator } from '@microsoft/api-extractor/lib/api/../generators/ApiModelGenerator';
import { ApiPackage, AedocDefinitions } from '@microsoft/api-extractor/node_modules/@microsoft/api-extractor-model/';
import { ApiReportGenerator } from '@microsoft/api-extractor/lib/api/../generators/ApiReportGenerator';
import { PackageMetadataManager } from '@microsoft/api-extractor/lib/api/../analyzer/PackageMetadataManager';
import { ValidationEnhancer } from '@microsoft/api-extractor/lib/api/../enhancers/ValidationEnhancer';
import { DocCommentEnhancer } from '@microsoft/api-extractor/lib/api/../enhancers/DocCommentEnhancer';
import { CompilerState } from '@microsoft/api-extractor/lib/api/./CompilerState';
import { ExtractorMessage } from '@microsoft/api-extractor/lib/api/ExtractorMessage';
import { MessageRouter } from '@microsoft/api-extractor/lib/api/../collector/MessageRouter';
import { ConsoleMessageId } from '@microsoft/api-extractor/lib/api/./ConsoleMessageId';
...
export class Extractor {
  ...
  public static invoke(extractorConfig: ExtractorConfig, options?: IExtractorInvokeOptions): ExtractorResult {
    ...
    const collector: Collector = new Collector({
      program: compilerState.program as Program,
      messageRouter,
      extractorConfig: extractorConfig
    });

    // const aeConfiguration = AedocDefinitions.tsdocConfiguration as unknown as tsdoc.TSDocConfiguration
    ...
    //@ts-ignore;
    collector._tsdocParser = new tsdoc.TSDocParser(configuration);
    console.log('come on')
    collector.analyze();
